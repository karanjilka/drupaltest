...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:root@localhost/drupalexam?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:root@localhost/drupalexam?new_link=true');
  }
}
...
$civicrm_root = '/home/karan/karan/code/temp/drupalexam/code/drupal/sites/all/modules/contrib/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/karan/karan/code/temp/drupalexam/code/drupal/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://drupalexam.kr/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'd4c27ab5d0ec528dc82b9a2222a9ce58');
}
...
// define( 'CIVICRM_MAIL_LOG', '/home/karan/karan/code/temp/drupalexam/code/drupal/sites/default/files/civicrm/templates_c//mail.log');
// }
